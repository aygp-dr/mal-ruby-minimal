...
# Adds exception handling with try*/catch* special form
...
def create_core_fns
  ...
  # List manipulation
  %w[cons concat car cdr].each { |op| core[op] = op }
...
if __FILE__ == $0
  ...
  # Interactive REPL
  puts "Step 9: Try/Catch Exception Handling"
  puts "Try: (try* (throw \"error!\") (catch* e (str \"Caught: \" e)))"
  puts "Or: (try* (/ 1 0) (catch* e \"Division by zero!\"))"
